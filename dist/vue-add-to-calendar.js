...
var AddToCalendarMixin = {
	template: "<a v-if=\"calendar == 'icalendar'\" v-on:click.prevent=\"$parent.downloadCal(calendar)\" :class=\"calendarClass\"><slot></slot></a><a v-else :href=\"$parent.calendarUrl(calendar)\" :class=\"calendarClass\" target=\"_blank\"><slot></slot></a>",
